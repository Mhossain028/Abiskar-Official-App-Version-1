...
public class SigninActivity extends AppCompatActivity {
    ...
    private TextView registerTextView, contactTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerTextView = findViewById(R.id.signinActivityRegisterTextViewID);
        contactTextView = findViewById(R.id.signinActivityContactTextViewID);
        ...
        registerTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("WebCode", "register");
        ...
        contactTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SigninActivity.this, ContactUsActivity.class);
